...
- 🧠 **Agentic task execution** — automatic planning + tool actions  
- 📄 **PDF / text analysis**  
- 🌐 **Web search tasks** (optional)  
- 🪄 **Natural language command execution**  
- 🔌 **Modular architecture** — easily add your own tools  
- 💻 **Runs locally** — Python-based, no heavy setup required  
